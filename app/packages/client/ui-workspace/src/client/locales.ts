...
export const zh = {
  ...
  'folderError.remoteAccess': '为了数据安全，建议将 https://github.com/LucasIdeal/personal-agent/ 部署至本地或内网环境使用。',
  'rename': '重命名',
...
export const en = {
  ...
  'folderError.remoteAccess': 'For data security, deploy https://github.com/LucasIdeal/personal-agent/ in a local or private-network environment.',
  'rename': 'Rename',
