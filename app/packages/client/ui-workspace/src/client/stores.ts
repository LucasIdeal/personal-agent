...
/** Sidebar list filter: chat-home sessions vs project workspaces. */
export type SessionListMode = 'chat' | 'workspace'
...
type WorkspaceViewActions = {
  setListMode: (draft: WorkspaceViewState, mode: SessionListMode) => void
...
export function createWorkspaceViewStore(): EngineStoreHandle<WorkspaceViewState, WorkspaceViewActions> {
  return defineStore({
    ...
    actions: {
      setListMode: (d, mode: SessionListMode) => { d.listMode = mode },
