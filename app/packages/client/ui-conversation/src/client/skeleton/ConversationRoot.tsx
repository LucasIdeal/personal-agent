...
import { ChatBadge, HeroGlow, HeroHints, HeroShell, HomeModePicker, WorkspaceChip, workspaceLabel } from './EmptyHero.tsx'
import css from './ConversationRoot.module.css'
import heroCss from './HeroShell.module.css'
...
export function ConversationRoot({
  ...
  renderSlot, renderSlotChain, selectWorkspace, startChat, t,
  ...
  const [homeMode, setHomeMode] = useState<'choose' | 'workspace'>('choose')
    ...
    ?? (sessionId === undefined
      ...
      : sessionWorkspace?.title
        ?? (workspaces.phase === 'ready' || cwd === undefined || cwd === ''
          ? undefined
          : workspaceLabel(cwd)))
  const isChatSession = sessionWorkspace !== undefined
    ? isChatHomePath(sessionWorkspace.path)
    : cwd !== undefined && cwd !== '' && isChatHomePath(cwd)
  const showChooser = hero && !isChatSession && chipTitle === undefined && homeMode === 'choose'
  ...
  const heroWorkspaceRow = (
    <div className={css.heroWorkspaceRow}>
      ...
      {homeMode === 'workspace' && sessionId === undefined && (
        <button type="button" className={heroCss.back} onClick={() => { setHomeMode('choose') }}>
          {t('home.back')}
        </button>
      )}
  ...
  const inert = !isChatSession && (sessionId === undefined || (hero && chipTitle === undefined))
  ...
  const inputBar = renderSlot('conversation.composer.bar', {
    ...
    ...(inert
      ...
      : blocked
        ...
        : hero
          ? { placeholder: t(isChatSession ? 'placeholder.chat' : 'placeholder.hero') }
          : {}),
