...
export const zh = {
  ...
  'home.workspace.title': '基于工作区',
  'home.workspace.body': '选择项目目录，读写文件、运行命令',
  'home.chat.title': '纯聊天',
  'home.chat.body': '不绑定项目，对话和轨迹会保存到数据库',
  'home.chatBadge': '纯聊天',
  'home.back': '返回',
  'home.hints.title': '你可以这样开始',
  'home.hints.empty': '正在准备建议…',
  'home.hints.refresh': '换一批',
  'home.hints.refreshing': '换一批…',
  'placeholder.chat': '发消息给智能助理',
...
export const en = {
  ...
  'placeholder.default': 'Message the assistant',
  ...
  'hero.headline': 'Assistant',
  'hero.preview': 'Dept Review',
  'hero.chooseWorkspace': 'Choose workspace',
  'home.workspace.title': 'Workspace',
  'home.workspace.body': 'Pick a project folder to read, edit, and run commands',
  'home.chat.title': 'Chat',
  'home.chat.body': 'No project folder. Conversations and traces stay in the database',
  'home.chatBadge': 'Chat',
  'home.back': 'Back',
  'home.hints.title': 'You can start with',
  'home.hints.empty': 'Preparing suggestions…',
  'home.hints.refresh': 'Refresh',
  'home.hints.refreshing': 'Refreshing…',
  'placeholder.chat': 'Message the assistant',
